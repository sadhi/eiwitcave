...
//    glGenVertexArrays(1, &_vertexArray);
 //   glBindVertexArray(_vertexArray);
	...
	colors.push_back(0.5);
	glBufferData(GL_ARRAY_BUFFER, finalVertices.size()*sizeof(GLfloat), &colors.at(0), GL_STATIC_DRAW);*/
...
void ObjModel::draw()
{
	...
	//48 refers to the size of each block in the finalVertices which is 12 floats so 12*4bytes = 48
